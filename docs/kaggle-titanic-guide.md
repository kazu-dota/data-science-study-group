...
第13～14回の模擬コンペで覚えた「問題確認→ローカル検証→提出CSV作成→提出」の流れを、実際のKaggle過去コンペで1回経験します。順位を競うことは目的にしません。
...
[任意実践Notebook](../lessons/13-kaggle-kickoff/titanic_optional.ipynb)を上から順に実行します。データがまだない場合は、置き場所を表示して安全に停止します。
