...
5つのNotebookは、各回で最低限動かす実習です。問題設定、統計・可視化、前処理、
データリーク、過学習、分割方法、クラス不均衡、特徴量作成、設定探索、再現性は、
[外部資料の学習ガイド](docs/resources.md)と追加演習で補います。

1回あたり、事前学習100〜160分、勉強会120分、復習50〜105分を目安にします。
外部資料は「ここから」「ここまで」の見出しを指定しているため、教材全体を読む必要はありません。
